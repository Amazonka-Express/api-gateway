...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AuthenticateWithGoogle = channel.unary_unary(
            "/user_service.UserService/AuthenticateWithGoogle",
            request_serializer=user__service__pb2.AuthenticateWithGoogleRequest.SerializeToString,
            response_deserializer=user__service__pb2.AuthenticateWithGoogleResponse.FromString,
            _registered_method=True,
        )
        self.GetUserByEmail = channel.unary_unary(
            "/user_service.UserService/GetUserByEmail",
            request_serializer=user__service__pb2.GetUserByEmailRequest.SerializeToString,
        ...
        self.Delete = channel.unary_unary(
            "/user_service.UserService/Delete",
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
        "AuthenticateWithGoogle": grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=user__service__pb2.AuthenticateWithGoogleRequest.FromString,
            response_serializer=user__service__pb2.AuthenticateWithGoogleResponse.SerializeToString,
        ),
        "GetUserByEmail": grpc.unary_unary_rpc_method_handler(
            servicer.GetUserByEmail,
            request_deserializer=user__service__pb2.GetUserByEmailRequest.FromString,
...
class UserService(object):
    ...
    def AuthenticateWithGoogle(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/user_service.UserService/AuthenticateWithGoogle",
            user__service__pb2.AuthenticateWithGoogleRequest.SerializeToString,
            user__service__pb2.AuthenticateWithGoogleResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetUserByEmail(
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            "/user_service.UserService/GetUserByEmail",
            user__service__pb2.GetUserByEmailRequest.SerializeToString,
